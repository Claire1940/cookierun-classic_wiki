...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.cookierun-classic.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'CookieRun Classic Wiki'
