...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - CookieRun Classic Wiki",
    description: "Read the Terms of Service for CookieRun Classic Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our CookieRun Classic fan resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - CookieRun Classic Wiki",
      description: "Terms and conditions for using CookieRun Classic Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using CookieRun Classic Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using CookieRun Classic Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and CookieRun Classic Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              CookieRun Classic Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the mobile game "CookieRun Classic" (available on iOS and Android). Our services include, but are not limited to:
            </p>
            <ul>
              <li>Codes and redeem code guides</li>
              <li>Cookie, Pet, and Treasure guides and tier lists</li>
              <li>Combi (Cookie + Pet + Treasure) recommendations</li>
              <li>Event, launch reward, and League guides</li>
              <li>Beginner tips and progression strategies</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> CookieRun Classic Wiki is NOT affiliated with, endorsed by, or associated with
              Devsisters Corporation or the official developers of CookieRun Classic. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by CookieRun Classic Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Devsisters Corporation and/or the developers of CookieRun Classic. We use such
            ...
            <ul>
              ...
              <li><strong>Codes and Rewards:</strong> Redeem codes, launch rewards, and event details may change or expire without notice. Always verify with official CookieRun Classic sources.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, COOKIERUN CLASSIC WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including the App Store, Google Play, Discord, social media platforms,
            ...
            <p>
              ...
              you and CookieRun Classic Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@cookierun-classic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@cookierun-classic.wiki</a>
            </p>
            <p>
