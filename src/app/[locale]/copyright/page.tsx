...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - CookieRun Classic Wiki',
    description: 'Copyright and intellectual property information for CookieRun Classic Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - CookieRun Classic Wiki',
      description: 'Copyright and intellectual property information for CookieRun Classic Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 CookieRun Classic Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of CookieRun Classic Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              CookieRun Classic Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Devsisters Corporation</strong> - Developer and publisher of CookieRun Classic</li>
              <li><strong>Apple App Store</strong> and <strong>Google Play</strong> - Distribution platforms</li>
            </ul>
            <p>
              All game-related content, including but not limited to:
            </p>
            <ul>
              <li>Character (Cookie) images and artwork</li>
              <li>Game screenshots and interface elements</li>
              <li>Game logos and branding</li>
              <li>Cookie, Pet, and Treasure names and abilities</li>
              <li>In-game items, Jellies, and mechanics</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>CookieRun Classic</strong> and <strong>CookieRun</strong> - Trademarks of Devsisters Corporation</li>
              <li><strong>App Store</strong> - Trademark of Apple Inc.</li>
              <li><strong>Google Play</strong> - Trademark of Google LLC</li>
              <li><strong>CookieRun Classic Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with CookieRun Classic Wiki.
            </p>
            ...
            <p>
              ...
              CookieRun Classic Wiki<br />
              Email: <a href="mailto:dmca@cookierun-classic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@cookierun-classic.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "CookieRun Classic Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: CookieRun Classic Wiki (cookierun-classic.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@cookierun-classic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@cookierun-classic.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@cookierun-classic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@cookierun-classic.wiki</a>
            </p>
            <p>
