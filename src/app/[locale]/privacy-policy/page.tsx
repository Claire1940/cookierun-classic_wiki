...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - CookieRun Classic Wiki',
    description: 'CookieRun Classic Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our CookieRun Classic fan resource platform. Your privacy matters to us.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              CookieRun Classic Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including the App Store, Google Play, Discord, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              CookieRun Classic Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Devsisters Corporation or the developers of CookieRun Classic. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@cookierun-classic.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@cookierun-classic.wiki</a>
            </p>
            <p>
